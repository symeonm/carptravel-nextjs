    ...
    <section className=" pt-[36px] md:pt-[25px] xl:pt-[24px] bg-center bg-cover bg-hero xl:bg-heroDesk h-[642px] md:h-[530px] xl:h-[763px] ">
      ...
      <div className="md:flex">
        <div className="relative mt-[36px] md:mt-[66px] xl:mt-[72px] flex flex-col container">
          <h2 className=" absolute top-0 right-[20px] xl:right-[24px] xl:w-[306px] md:top-[20px] text-white font-thin text-4xl md:text-[67px] xl:text-[98px] md:tracking-[7px] tracking-[1.665px] xl:tracking-normal uppercase flex flex-wrap  w-[118px] md:w-[238px] md:h-[81px] xl:h-[123px]">
            <span className="text-white font-medium text-4xl xl:text-[98px] md:text-[67px]">
              7
            </span>
            DAYS
            <span className="text-xs md:text-sm xl:text-[16px] font-light tracking-[9.48px] md:tracking-[25.9px] xl:tracking-[36.48px] uppercase text-white md:h-[17px] ">
              JOURNEY
            </span>
          </h2>
          ...
          <div className="md:absolute md:bottom-0 md:right-[30px] flex flex-col justify-start text-justify ml-auto xl:mt-auto">
